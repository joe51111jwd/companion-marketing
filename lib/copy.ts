...
export const hero = {
  ...
  /** §8.10, sentence 1 — still the trust spine under the skills headline. */
...
export const closing = {
  ...
  body: `Seven days, no card. ${RISK_REVERSAL.headline} Turn repeats into skills — safely. ${TAGLINE.pauseDelete}`,
  cta: { label: "Start the 7-day trial", href: "/signup" },
  waitlist: { label: "Or join the waitlist", href: "/signup?plan=team&waitlist=1" },
};
...
/** Recorded Skills hero demo — mock product window only. */
export const skillsDemo = {
  eyebrow: "Recorded Skills",
  windowTitle: `${PRODUCT_NAME} · Ask / Skills`,
  skillName: "Friday parent update",
  skillMeta: "Gmail · recorded once · streamlined",
  localBadge: "Local only",
  trustLine: "Capture stays on this Mac. Accessibility-first. Nothing uploaded in the background.",
  flowLabel: "How it became a skill",
  flow: [
    { n: "01", title: "Notice", body: "Same reply shape, nine times last week." },
    { n: "02", title: "Teach", body: "Walkthrough in Claude beside Gmail." },
    { n: "03", title: "Record once", body: "You opt in. Steps stay on this Mac." },
    { n: "04", title: "AI streamlines", body: "Redundant clicks dropped. Prompt locked." },
  ],
  stepsLabel: "Recorded steps",
  steps: [
    { id: "1", title: "Open Gmail compose", meta: "App focus" },
    { id: "2", title: "Paste bullet list of updates", meta: "Clipboard stay local" },
    { id: "3", title: "Ask Claude for parent-update drafts", meta: "Tool already installed" },
    { id: "4", title: "Review tone · send", meta: "You stay in control" },
  ],
  runLabel: "Run skill",
  runHint: "One button. Same outcome. Minutes back.",
  exampleBadge: "Example skill",
  exampleNote: "Mock UI for the product story — Recorded Skills is the advertised next wedge.",
};

/**
 * CoFounder Stage 3 offer band — audience, result, price, guarantee,
 * pay/commit path, waitlist fallback. Uses existing /signup and /pricing.
 */
export const offerBand = {
  eyebrow: "The offer",
  audience: "For managers who must show AI adoption — company buyer first.",
  result: "Your team hands three real tasks a day to the AI tools they already have. Minutes back, measured. Recorded Skills turns the repeats into one-button runs.",
  price: `${PRICING.teamPrice}${PRICING.teamPeriod} teams (${PRICING.teamMinimum}) · ${PRICING.individualPrice}${PRICING.individualPeriod} individual · ${PRICING.trial}.`,
  ...
  waitlistCta: { label: "Join the waitlist", href: "/signup?plan=team&waitlist=1" },
  waitlistNote: "Not ready to commit? Join the waitlist — same form, we hold a seat and ping you when Alpha invites open.",
};
  ...
  items: [
    {
      ...
      title: "Turn your actions into skills automatically.",
      body: "Companion notices the repeat, teaches the AI walkthrough, then offers to record once. AI streamlines the steps into a one-button skill. Capture stays local — accessibility-first, no bossware, nothing uploaded in the background.",
      href: "#demo",
      link: "See the skill window",
    },
    {
      id: "digest",
